...
export default class Up1 extends React.Component {
    ...
    render() {
        return (
        	<button className={this.props.userId in this.props.voters && this.props.voters[this.props.userId]===true ? "cbutton cbutton--effect-ivana1" : "cbutton cbutton--effect-ivana"}>
